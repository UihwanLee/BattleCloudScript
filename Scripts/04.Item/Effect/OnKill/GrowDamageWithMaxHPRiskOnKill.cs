...
public class GrowDamageWithMaxHPRiskOnKill : IWeaponEffectInstance, IRebindableWeaponEffect
{
    ...
    public GrowDamageWithMaxHPRiskOnKill(int id, Effect effect)
    {
        ItemId = id;
        this.effect = effect;
    ...
    public void OnEquip()
    {
        ...
        riskHp = (int)effect.ValueList[2];

        weapon.Controller.OnKill += OnKill;
        weapon.Stat.Add(AttributeType.Damage, growCount * growDamage);
        GameManager.Instance.Player.Condition.Add(AttributeType.MaxHp, growCount * riskHp);
    }
    ...
    public void OnUnequip()
    {
        ...
        GameManager.Instance.Player.Condition.Sub(AttributeType.MaxHp, growCount * riskHp);
    }
    ...
    private void OnKill(HitInfo hitInfo)
    {
        ...
        if (killsRemaining >= killsRequired)
        {
            ...
            GameManager.Instance.Player.Condition.Add(AttributeType.MaxHp, riskHp);
        }
    }
}
